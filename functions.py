...
#OPENAI_API_KEY = os.environ['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'] os.environ['GOOGLE_CLOUD_API_KEY'] os.environ['AIRTABLE_API_KEY']
OPENAI_API_KEY = "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"
